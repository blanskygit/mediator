...
var WebSocketServer =  require('C:\\Program Files\\nodejs\\node_modules\\websocket').server;
    ...
    function processSignalingMessage(con, message) {
        ...
        switch (msg.msg_type) {
            ...
            case "OFFER":
                ...
                sigchannel = registerMap.get(msg.caleeid);
                if (sigchannel === null) {
                    console.log("The call [" + msg.callid + "] OFFER attempt from [" + msg.userid + "] to [" + msg.caleeid + "] FAILED, " + msg.caleeid + "not registered");
                ...
                console.log("OFFER [" + msg.userid + "]-->[" + msg.caleeid + "], SDP =\n" + msg.data.sdp);
                
                var callDetails = new CallDetails(msg.callid, new CallParty(msg.userid, con), new CallParty(msg.caleeid, sigchannel));
            ...
            case "ANSWER":
                ...
                callDetails = activeCallMap[msg.callid];
                if (callDetails === null) {
            ...
            case "REGISTER":
                ...
                registerMap[message.userid] = con;
                userDataBySigchannel[con] = new UserData(message.userid);
                console.log("REGISTER userid=[" + message.userid + "], sigchannel=[" +  con + "], remoteaddress=[" + con.remoteAddress + "]");
